...
# Decompiled from: Python 2.7.5 (default, Aug 13 2020, 02:51:10)
# [GCC 4.8.5 20150623 (Red Hat 4.8.5-39)]
# Warning: this version of Python has problems handling the Python 3 byte type in constants properly.

# Embedded file name: /usr/lib64/python2.7/site-packages/libvirt.py
# Compiled at: 2018-11-02 23:46:26
import sys
...
class virDomain(object):
    ...
    def OSType(self):
        ...
        if ret is None:
            raise libvirtError('virDomainGetOSType() failed', dom=self)
        return ret
    ...
    def UUID(self):
        ...
        if ret is None:
            raise libvirtError('virDomainGetUUID() failed', dom=self)
        return ret
    ...
    def UUIDString(self):
        ...
        if ret is None:
            raise libvirtError('virDomainGetUUIDString() failed', dom=self)
        return ret
    ...
    def XMLDesc(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetXMLDesc() failed', dom=self)
        return ret
    ...
    def abortJob(self):
        ...
        if ret == -1:
            raise libvirtError('virDomainAbortJob() failed', dom=self)
        return ret
    ...
    def addIOThread(self, iothread_id, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainAddIOThread() failed', dom=self)
        return ret
    ...
    def attachDevice(self, xml):
        ...
        if ret == -1:
            raise libvirtError('virDomainAttachDevice() failed', dom=self)
        return ret
    ...
    def autostart(self):
        ...
        if ret == -1:
            raise libvirtError('virDomainGetAutostart() failed', dom=self)
        return ret
    ...
    def blkioParameters(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetBlkioParameters() failed', dom=self)
        return ret
    ...
    def blockCopy(self, disk, destxml, params=None, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainBlockCopy() failed', dom=self)
        return ret
    ...
    def blockInfo(self, path, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetBlockInfo() failed', dom=self)
        return ret
    ...
    def blockIoTune(self, disk, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetBlockIoTune() failed', dom=self)
        return ret
    ...
    def blockJobInfo(self, path, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetBlockJobInfo() failed', dom=self)
        return ret
    ...
    def blockJobSetSpeed(self, disk, bandwidth, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainBlockJobSetSpeed() failed', dom=self)
        return ret
    ...
    def blockPeek(self, disk, offset, size, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainBlockPeek() failed', dom=self)
        return ret
    ...
    def blockPull(self, disk, bandwidth=0, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainBlockPull() failed', dom=self)
        return ret
    ...
    def blockResize(self, disk, size, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainBlockResize() failed', dom=self)
        return ret
    ...
    def blockStats(self, path):
        ...
        if ret is None:
            raise libvirtError('virDomainBlockStats() failed', dom=self)
        return ret
    ...
    def blockStatsFlags(self, path, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainBlockStatsFlags() failed', dom=self)
        return ret
    ...
    def controlInfo(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetControlInfo() failed', dom=self)
        return ret
    ...
    def coreDump(self, to, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainCoreDump() failed', dom=self)
        return ret
    ...
    def coreDumpWithFormat(self, to, dumpformat, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainCoreDumpWithFormat() failed', dom=self)
        return ret
    ...
    def delIOThread(self, iothread_id, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainDelIOThread() failed', dom=self)
        return ret
    ...
    def destroy(self):
        ...
        if ret == -1:
            raise libvirtError('virDomainDestroy() failed', dom=self)
        return ret
    ...
    def destroyFlags(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainDestroyFlags() failed', dom=self)
        return ret
    ...
    def detachDevice(self, xml):
        ...
        if ret == -1:
            raise libvirtError('virDomainDetachDevice() failed', dom=self)
        return ret
    ...
    def detachDeviceAlias(self, alias, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainDetachDeviceAlias() failed', dom=self)
        return ret
    ...
    def diskErrors(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetDiskErrors() failed', dom=self)
        return ret
    ...
    def emulatorPinInfo(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetEmulatorPinInfo() failed', dom=self)
        return ret
    ...
    def fSTrim(self, mountPoint, minimum, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainFSTrim() failed', dom=self)
        return ret
    ...
    def fsInfo(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetFSInfo() failed', dom=self)
        return ret
    ...
    def getCPUStats(self, total, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetCPUStats() failed', dom=self)
        return ret
    ...
    def guestVcpus(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainGetGuestVcpus() failed', dom=self)
        return ret
    ...
    def hasCurrentSnapshot(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainHasCurrentSnapshot() failed', dom=self)
        return ret
    ...
    def hasManagedSaveImage(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainHasManagedSaveImage() failed', dom=self)
        return ret
    ...
    def hostname(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetHostname() failed', dom=self)
        return ret
    ...
    def info(self):
        ...
        if ret is None:
            raise libvirtError('virDomainGetInfo() failed', dom=self)
        return ret
    ...
    def injectNMI(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainInjectNMI() failed', dom=self)
        return ret
    ...
    def interfaceAddresses(self, source, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainInterfaceAddresses() failed', dom=self)
        return ret
    ...
    def interfaceParameters(self, device, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetInterfaceParameters() failed', dom=self)
        return ret
    ...
    def interfaceStats(self, path):
        ...
        if ret is None:
            raise libvirtError('virDomainInterfaceStats() failed', dom=self)
        return ret
    ...
    def ioThreadInfo(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetIOThreadInfo() failed', dom=self)
        return ret
    ...
    def isActive(self):
        ...
        if ret == -1:
            raise libvirtError('virDomainIsActive() failed', dom=self)
        return ret
    ...
    def isPersistent(self):
        ...
        if ret == -1:
            raise libvirtError('virDomainIsPersistent() failed', dom=self)
        return ret
    ...
    def isUpdated(self):
        ...
        if ret == -1:
            raise libvirtError('virDomainIsUpdated() failed', dom=self)
        return ret
    ...
    def jobInfo(self):
        ...
        if ret is None:
            raise libvirtError('virDomainGetJobInfo() failed', dom=self)
        return ret
    ...
    def jobStats(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetJobStats() failed', dom=self)
        return ret
    ...
    def launchSecurityInfo(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetLaunchSecurityInfo() failed', dom=self)
        return ret
    ...
    def managedSaveDefineXML(self, dxml, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainManagedSaveDefineXML() failed', dom=self)
        return ret
    ...
    def managedSaveGetXMLDesc(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainManagedSaveGetXMLDesc() failed', dom=self)
        return ret
    ...
    def managedSaveRemove(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainManagedSaveRemove() failed', dom=self)
        return ret
    ...
    def maxMemory(self):
        ...
        if ret == 0:
            raise libvirtError('virDomainGetMaxMemory() failed', dom=self)
        return ret
    ...
    def maxVcpus(self):
        ...
        if ret == -1:
            raise libvirtError('virDomainGetMaxVcpus() failed', dom=self)
        return ret
    ...
    def memoryParameters(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetMemoryParameters() failed', dom=self)
        return ret
    ...
    def memoryPeek(self, start, size, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainMemoryPeek() failed', dom=self)
        return ret
    ...
    def memoryStats(self):
        ...
        if ret is None:
            raise libvirtError('virDomainMemoryStats() failed', dom=self)
        return ret
    ...
    def metadata(self, type, uri, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetMetadata() failed', dom=self)
        return ret
    ...
    def migrate(self, dconn, flags=0, dname=None, uri=None, bandwidth=0):
        ...
        if ret is None:
            raise libvirtError('virDomainMigrate() failed', dom=self)
    ...
    def migrate2(self, dconn, dxml=None, flags=0, dname=None, uri=None, bandwidth=0):
        ...
        if ret is None:
            raise libvirtError('virDomainMigrate2() failed', dom=self)
        __tmp = virDomain(self, _obj=ret)
        return __tmp
    ...
    def migrate3(self, dconn, params, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainMigrate3() failed', dom=self)
        __tmp = virDomain(self, _obj=ret)
        return __tmp
    ...
    def migrateGetMaxSpeed(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainMigrateGetMaxSpeed() failed', dom=self)
        return ret
    ...
    def migrateSetCompressionCache(self, cacheSize, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainMigrateSetCompressionCache() failed', dom=self)
        return ret
    ...
    def migrateSetMaxDowntime(self, downtime, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainMigrateSetMaxDowntime() failed', dom=self)
        return ret
    ...
    def migrateSetMaxSpeed(self, bandwidth, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainMigrateSetMaxSpeed() failed', dom=self)
        return ret
    ...
    def migrateStartPostCopy(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainMigrateStartPostCopy() failed', dom=self)
        return ret
    ...
    def migrateToURI(self, duri, flags=0, dname=None, bandwidth=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainMigrateToURI() failed', dom=self)
        return ret
    ...
    def migrateToURI2(self, dconnuri=None, miguri=None, dxml=None, flags=0, dname=None, bandwidth=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainMigrateToURI2() failed', dom=self)
        return ret
    ...
    def numaParameters(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetNumaParameters() failed', dom=self)
        return ret
    ...
    def openChannel(self, name, st, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainOpenChannel() failed', dom=self)
        return ret
    ...
    def openConsole(self, dev_name, st, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainOpenConsole() failed', dom=self)
        return ret
    ...
    def openGraphics(self, idx, fd, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainOpenGraphics() failed', dom=self)
        return ret
    ...
    def openGraphicsFD(self, idx, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainOpenGraphicsFD() failed', dom=self)
        return ret
    ...
    def pMSuspendForDuration(self, target, duration, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainPMSuspendForDuration() failed', dom=self)
        return ret
    ...
    def pMWakeup(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainPMWakeup() failed', dom=self)
        return ret
    ...
    def perfEvents(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetPerfEvents() failed', dom=self)
        return ret
    ...
    def pinEmulator(self, cpumap, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainPinEmulator() failed', dom=self)
        return ret
    ...
    def pinIOThread(self, iothread_val, cpumap, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainPinIOThread() failed', dom=self)
        return ret
    ...
    def pinVcpu(self, vcpu, cpumap):
        ...
        if ret == -1:
            raise libvirtError('virDomainPinVcpu() failed', dom=self)
        return ret
    ...
    def pinVcpuFlags(self, vcpu, cpumap, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainPinVcpuFlags() failed', dom=self)
        return ret
    ...
    def reboot(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainReboot() failed', dom=self)
        return ret
    ...
    def rename(self, new_name, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainRename() failed', dom=self)
        return ret
    ...
    def reset(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainReset() failed', dom=self)
        return ret
    ...
    def resume(self):
        ...
        if ret == -1:
            raise libvirtError('virDomainResume() failed', dom=self)
        return ret
    ...
    def revertToSnapshot(self, snap, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainRevertToSnapshot() failed', dom=self)
        return ret
    ...
    def save(self, to):
        ...
        if ret == -1:
            raise libvirtError('virDomainSave() failed', dom=self)
        return ret
    ...
    def saveFlags(self, to, dxml=None, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSaveFlags() failed', dom=self)
        return ret
    ...
    def schedulerParameters(self):
        ...
        if ret is None:
            raise libvirtError('virDomainGetSchedulerParameters() failed', dom=self)
        return ret
    ...
    def schedulerParametersFlags(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetSchedulerParametersFlags() failed', dom=self)
        return ret
    ...
    def schedulerType(self):
        ...
        if ret is None:
            raise libvirtError('virDomainGetSchedulerType() failed', dom=self)
        return ret
    ...
    def screenshot(self, stream, screen, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainScreenshot() failed', dom=self)
        return ret
    ...
    def securityLabel(self):
        ...
        if ret is None:
            raise libvirtError('virDomainGetSecurityLabel() failed', dom=self)
        return ret
    ...
    def securityLabelList(self):
        ...
        if ret is None:
            raise libvirtError('virDomainGetSecurityLabelList() failed', dom=self)
        return ret
    ...
    def sendKey(self, codeset, holdtime, keycodes, nkeycodes, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSendKey() failed', dom=self)
        return ret
    ...
    def sendProcessSignal(self, pid_value, signum, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSendProcessSignal() failed', dom=self)
        return ret
    ...
    def setAutostart(self, autostart):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetAutostart() failed', dom=self)
        return ret
    ...
    def setBlkioParameters(self, params, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetBlkioParameters() failed', dom=self)
        return ret
    ...
    def setBlockIoTune(self, disk, params, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetBlockIoTune() failed', dom=self)
        return ret
    ...
    def setBlockThreshold(self, dev, threshold, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetBlockThreshold() failed', dom=self)
        return ret
    ...
    def setGuestVcpus(self, cpumap, state, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetGuestVcpus() failed', dom=self)
        return ret
    ...
    def setInterfaceParameters(self, device, params, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetInterfaceParameters() failed', dom=self)
        return ret
    ...
    def setLifecycleAction(self, type, action, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetLifecycleAction() failed', dom=self)
        return ret
    ...
    def setMaxMemory(self, memory):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetMaxMemory() failed', dom=self)
        return ret
    ...
    def setMemory(self, memory):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetMemory() failed', dom=self)
        return ret
    ...
    def setMemoryFlags(self, memory, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetMemoryFlags() failed', dom=self)
        return ret
    ...
    def setMemoryParameters(self, params, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetMemoryParameters() failed', dom=self)
        return ret
    ...
    def setMemoryStatsPeriod(self, period, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetMemoryStatsPeriod() failed', dom=self)
        return ret
    ...
    def setMetadata(self, type, metadata, key, uri, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetMetadata() failed', dom=self)
        return ret
    ...
    def setNumaParameters(self, params, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetNumaParameters() failed', dom=self)
        return ret
    ...
    def setPerfEvents(self, params, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetPerfEvents() failed', dom=self)
        return ret
    ...
    def setSchedulerParameters(self, params):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetSchedulerParameters() failed', dom=self)
        return ret
    ...
    def setSchedulerParametersFlags(self, params, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetSchedulerParametersFlags() failed', dom=self)
        return ret
    ...
    def setUserPassword(self, user, password, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetUserPassword() failed', dom=self)
        return ret
    ...
    def setVcpu(self, vcpumap, state, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetVcpu() failed', dom=self)
        return ret
    ...
    def setVcpus(self, nvcpus):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetVcpus() failed', dom=self)
        return ret
    ...
    def setVcpusFlags(self, nvcpus, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSetVcpusFlags() failed', dom=self)
        return ret
    ...
    def shutdownFlags(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainShutdownFlags() failed', dom=self)
        return ret
    ...
    def snapshotCreateXML(self, xmlDesc, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainSnapshotCreateXML() failed', dom=self)
    ...
    def snapshotCurrent(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainSnapshotCurrent() failed', dom=self)
        __tmp = virDomainSnapshot(self, _obj=ret)
        return __tmp
    ...
    def snapshotListNames(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainSnapshotListNames() failed', dom=self)
        return ret
    ...
    def snapshotLookupByName(self, name, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainSnapshotLookupByName() failed', dom=self)
        __tmp = virDomainSnapshot(self, _obj=ret)
        return __tmp
    ...
    def snapshotNum(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSnapshotNum() failed', dom=self)
        return ret
    ...
    def state(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetState() failed', dom=self)
        return ret
    ...
    def suspend(self):
        ...
        if ret == -1:
            raise libvirtError('virDomainSuspend() failed', dom=self)
        return ret
    ...
    def undefine(self):
        ...
        if ret == -1:
            raise libvirtError('virDomainUndefine() failed', dom=self)
        return ret
    ...
    def undefineFlags(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainUndefineFlags() failed', dom=self)
        return ret
    ...
    def updateDeviceFlags(self, xml, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainUpdateDeviceFlags() failed', dom=self)
        return ret
    ...
    def vcpuPinInfo(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainGetVcpuPinInfo() failed', dom=self)
        return ret
    ...
    def vcpus(self):
        ...
        if ret is None:
            raise libvirtError('virDomainGetVcpus() failed', dom=self)
        return ret
    ...
    def vcpusFlags(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainGetVcpusFlags() failed', dom=self)
        return ret
...
class virNetwork(object):
    ...
    def DHCPLeases(self, mac=None, flags=0):
        ...
        if ret is None:
            raise libvirtError('virNetworkGetDHCPLeases() failed', net=self)
        return ret
    ...
    def UUID(self):
        ...
        if ret is None:
            raise libvirtError('virNetworkGetUUID() failed', net=self)
        return ret
    ...
    def UUIDString(self):
        ...
        if ret is None:
            raise libvirtError('virNetworkGetUUIDString() failed', net=self)
        return ret
    ...
    def XMLDesc(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virNetworkGetXMLDesc() failed', net=self)
        return ret
    ...
    def autostart(self):
        ...
        if ret == -1:
            raise libvirtError('virNetworkGetAutostart() failed', net=self)
        return ret
    ...
    def bridgeName(self):
        ...
        if ret is None:
            raise libvirtError('virNetworkGetBridgeName() failed', net=self)
        return ret
    ...
    def create(self):
        ...
        if ret == -1:
            raise libvirtError('virNetworkCreate() failed', net=self)
        return ret
    ...
    def destroy(self):
        ...
        if ret == -1:
            raise libvirtError('virNetworkDestroy() failed', net=self)
        return ret
    ...
    def isActive(self):
        ...
        if ret == -1:
            raise libvirtError('virNetworkIsActive() failed', net=self)
        return ret
    ...
    def isPersistent(self):
        ...
        if ret == -1:
            raise libvirtError('virNetworkIsPersistent() failed', net=self)
        return ret
    ...
    def setAutostart(self, autostart):
        ...
        if ret == -1:
            raise libvirtError('virNetworkSetAutostart() failed', net=self)
        return ret
    ...
    def undefine(self):
        ...
        if ret == -1:
            raise libvirtError('virNetworkUndefine() failed', net=self)
        return ret
    ...
    def update(self, command, section, parentIndex, xml, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virNetworkUpdate() failed', net=self)
        return ret
...
class virInterface(object):
    ...
    def MACString(self):
        ...
        if ret is None:
            raise libvirtError('virInterfaceGetMACString() failed', net=self)
        return ret
    ...
    def XMLDesc(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virInterfaceGetXMLDesc() failed', net=self)
        return ret
    ...
    def create(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virInterfaceCreate() failed', net=self)
        return ret
    ...
    def destroy(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virInterfaceDestroy() failed', net=self)
        return ret
    ...
    def isActive(self):
        ...
        if ret == -1:
            raise libvirtError('virInterfaceIsActive() failed', net=self)
        return ret
    ...
    def undefine(self):
        ...
        if ret == -1:
            raise libvirtError('virInterfaceUndefine() failed', net=self)
        return ret
...
class virStoragePool(object):
    ...
    def UUID(self):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolGetUUID() failed', pool=self)
        return ret
    ...
    def UUIDString(self):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolGetUUIDString() failed', pool=self)
        return ret
    ...
    def XMLDesc(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolGetXMLDesc() failed', pool=self)
        return ret
    ...
    def autostart(self):
        ...
        if ret == -1:
            raise libvirtError('virStoragePoolGetAutostart() failed', pool=self)
        return ret
    ...
    def build(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virStoragePoolBuild() failed', pool=self)
        return ret
    ...
    def create(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virStoragePoolCreate() failed', pool=self)
        return ret
    ...
    def createXML(self, xmlDesc, flags=0):
        ...
        if ret is None:
            raise libvirtError('virStorageVolCreateXML() failed', pool=self)
    ...
    def createXMLFrom(self, xmlDesc, clonevol, flags=0):
        ...
        if ret is None:
            raise libvirtError('virStorageVolCreateXMLFrom() failed', pool=self)
        __tmp = virStorageVol(self, _obj=ret)
        return __tmp
    ...
    def delete(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virStoragePoolDelete() failed', pool=self)
        return ret
    ...
    def destroy(self):
        ...
        if ret == -1:
            raise libvirtError('virStoragePoolDestroy() failed', pool=self)
        return ret
    ...
    def info(self):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolGetInfo() failed', pool=self)
        return ret
    ...
    def isActive(self):
        ...
        if ret == -1:
            raise libvirtError('virStoragePoolIsActive() failed', pool=self)
        return ret
    ...
    def isPersistent(self):
        ...
        if ret == -1:
            raise libvirtError('virStoragePoolIsPersistent() failed', pool=self)
        return ret
    ...
    def listVolumes(self):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolListVolumes() failed', pool=self)
        return ret
    ...
    def numOfVolumes(self):
        ...
        if ret == -1:
            raise libvirtError('virStoragePoolNumOfVolumes() failed', pool=self)
        return ret
    ...
    def refresh(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virStoragePoolRefresh() failed', pool=self)
        return ret
    ...
    def setAutostart(self, autostart):
        ...
        if ret == -1:
            raise libvirtError('virStoragePoolSetAutostart() failed', pool=self)
        return ret
    ...
    def storageVolLookupByName(self, name):
        ...
        if ret is None:
            raise libvirtError('virStorageVolLookupByName() failed', pool=self)
        __tmp = virStorageVol(self, _obj=ret)
        return __tmp
    ...
    def undefine(self):
        ...
        if ret == -1:
            raise libvirtError('virStoragePoolUndefine() failed', pool=self)
        return ret
...
class virStorageVol(object):
    ...
    def XMLDesc(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virStorageVolGetXMLDesc() failed', vol=self)
        return ret
    ...
    def delete(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virStorageVolDelete() failed', vol=self)
        return ret
    ...
    def download(self, stream, offset, length, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virStorageVolDownload() failed', vol=self)
        return ret
    ...
    def info(self):
        ...
        if ret is None:
            raise libvirtError('virStorageVolGetInfo() failed', vol=self)
        return ret
    ...
    def infoFlags(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virStorageVolGetInfoFlags() failed', vol=self)
        return ret
    ...
    def key(self):
        ...
        if ret is None:
            raise libvirtError('virStorageVolGetKey() failed', vol=self)
        return ret
    ...
    def path(self):
        ...
        if ret is None:
            raise libvirtError('virStorageVolGetPath() failed', vol=self)
        return ret
    ...
    def resize(self, capacity, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virStorageVolResize() failed', vol=self)
        return ret
    ...
    def storagePoolLookupByVolume(self):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolLookupByVolume() failed', vol=self)
    ...
    def upload(self, stream, offset, length, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virStorageVolUpload() failed', vol=self)
        return ret
    ...
    def wipe(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virStorageVolWipe() failed', vol=self)
        return ret
    ...
    def wipePattern(self, algorithm, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virStorageVolWipePattern() failed', vol=self)
        return ret
...
class virConnect(object):
    ...
    def allocPages(self, pages, startCell=0, cellCount=0, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virNodeAllocPages() failed', conn=self)
        return ret
    ...
    def baselineCPU(self, xmlCPUs, flags=0):
        ...
        if ret is None:
            raise libvirtError('virConnectBaselineCPU() failed', conn=self)
        return ret
    ...
    def baselineHypervisorCPU(self, emulator, arch, machine, virttype, xmlCPUs, flags=0):
        ...
        if ret is None:
            raise libvirtError('virConnectBaselineHypervisorCPU() failed', conn=self)
        return ret
    ...
    def changeBegin(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virInterfaceChangeBegin() failed', conn=self)
        return ret
    ...
    def changeCommit(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virInterfaceChangeCommit() failed', conn=self)
        return ret
    ...
    def changeRollback(self, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virInterfaceChangeRollback() failed', conn=self)
        return ret
    ...
    def close(self):
        ...
        self._o = None
        if ret == -1:
            raise libvirtError('virConnectClose() failed', conn=self)
        return ret
    ...
    def compareCPU(self, xmlDesc, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virConnectCompareCPU() failed', conn=self)
        return ret
    ...
    def compareHypervisorCPU(self, emulator, arch, machine, virttype, xmlCPU, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virConnectCompareHypervisorCPU() failed', conn=self)
        return ret
    ...
    def createXML(self, xmlDesc, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainCreateXML() failed', conn=self)
        __tmp = virDomain(self, _obj=ret)
        return __tmp
    ...
    def defineXML(self, xml):
        ...
        if ret is None:
            raise libvirtError('virDomainDefineXML() failed', conn=self)
        __tmp = virDomain(self, _obj=ret)
        return __tmp
    ...
    def defineXMLFlags(self, xml, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainDefineXMLFlags() failed', conn=self)
        __tmp = virDomain(self, _obj=ret)
        return __tmp
    ...
    def domainXMLFromNative(self, nativeFormat, nativeConfig, flags=0):
        ...
        if ret is None:
            raise libvirtError('virConnectDomainXMLFromNative() failed', conn=self)
        return ret
    ...
    def domainXMLToNative(self, nativeFormat, domainXml, flags=0):
        ...
        if ret is None:
            raise libvirtError('virConnectDomainXMLToNative() failed', conn=self)
        return ret
    ...
    def findStoragePoolSources(self, type, srcSpec, flags=0):
        ...
        if ret is None:
            raise libvirtError('virConnectFindStoragePoolSources() failed', conn=self)
        return ret
    ...
    def getCPUModelNames(self, arch, flags=0):
        ...
        if ret is None:
            raise libvirtError('virConnectGetCPUModelNames() failed', conn=self)
        return ret
    ...
    def getCPUStats(self, cpuNum, flags=0):
        ...
        if ret is None:
            raise libvirtError('virNodeGetCPUStats() failed', conn=self)
        return ret
    ...
    def getCapabilities(self):
        ...
        if ret is None:
            raise libvirtError('virConnectGetCapabilities() failed', conn=self)
        return ret
    ...
    def getCellsFreeMemory(self, startCell, maxCells):
        ...
        if ret is None:
            raise libvirtError('virNodeGetCellsFreeMemory() failed', conn=self)
        return ret
    ...
    def getDomainCapabilities(self, emulatorbin, arch, machine, virttype, flags=0):
        ...
        if ret is None:
            raise libvirtError('virConnectGetDomainCapabilities() failed', conn=self)
        return ret
    ...
    def getFreePages(self, pages, startCell, maxCells, flags=0):
        ...
        if ret is None:
            raise libvirtError('virNodeGetFreePages() failed', conn=self)
        return ret
    ...
    def getHostname(self):
        ...
        if ret is None:
            raise libvirtError('virConnectGetHostname() failed', conn=self)
        return ret
    ...
    def getInfo(self):
        ...
        if ret is None:
            raise libvirtError('virNodeGetInfo() failed', conn=self)
        return ret
    ...
    def getLibVersion(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectGetLibVersion() failed', conn=self)
        return ret
    ...
    def getMaxVcpus(self, type):
        ...
        if ret == -1:
            raise libvirtError('virConnectGetMaxVcpus() failed', conn=self)
        return ret
    ...
    def getMemoryParameters(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virNodeGetMemoryParameters() failed', conn=self)
        return ret
    ...
    def getMemoryStats(self, cellNum, flags=0):
        ...
        if ret is None:
            raise libvirtError('virNodeGetMemoryStats() failed', conn=self)
        return ret
    ...
    def getSEVInfo(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virNodeGetSEVInfo() failed', conn=self)
        return ret
    ...
    def getSecurityModel(self):
        ...
        if ret is None:
            raise libvirtError('virNodeGetSecurityModel() failed', conn=self)
        return ret
    ...
    def getSysinfo(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virConnectGetSysinfo() failed', conn=self)
        return ret
    ...
    def getType(self):
        ...
        if ret is None:
            raise libvirtError('virConnectGetType() failed', conn=self)
        return ret
    ...
    def getURI(self):
        ...
        if ret is None:
            raise libvirtError('virConnectGetURI() failed', conn=self)
        return ret
    ...
    def getVersion(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectGetVersion() failed', conn=self)
        return ret
    ...
    def interfaceDefineXML(self, xml, flags=0):
        ...
        if ret is None:
            raise libvirtError('virInterfaceDefineXML() failed', conn=self)
    ...
    def interfaceLookupByMACString(self, macstr):
        ...
        if ret is None:
            raise libvirtError('virInterfaceLookupByMACString() failed', conn=self)
        __tmp = virInterface(self, _obj=ret)
        return __tmp
    ...
    def interfaceLookupByName(self, name):
        ...
        if ret is None:
            raise libvirtError('virInterfaceLookupByName() failed', conn=self)
        __tmp = virInterface(self, _obj=ret)
        return __tmp
    ...
    def isAlive(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectIsAlive() failed', conn=self)
        return ret
    ...
    def isEncrypted(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectIsEncrypted() failed', conn=self)
        return ret
    ...
    def isSecure(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectIsSecure() failed', conn=self)
        return ret
    ...
    def listDefinedDomains(self):
        ...
        if ret is None:
            raise libvirtError('virConnectListDefinedDomains() failed', conn=self)
        return ret
    ...
    def listDefinedInterfaces(self):
        ...
        if ret is None:
            raise libvirtError('virConnectListDefinedInterfaces() failed', conn=self)
        return ret
    ...
    def listDefinedNetworks(self):
        ...
        if ret is None:
            raise libvirtError('virConnectListDefinedNetworks() failed', conn=self)
        return ret
    ...
    def listDefinedStoragePools(self):
        ...
        if ret is None:
            raise libvirtError('virConnectListDefinedStoragePools() failed', conn=self)
        return ret
    ...
    def listDevices(self, cap, flags=0):
        ...
        if ret is None:
            raise libvirtError('virNodeListDevices() failed', conn=self)
        return ret
    ...
    def listDomainsID(self):
        ...
        if ret is None:
            raise libvirtError('virConnectListDomainsID() failed', conn=self)
        return ret
    ...
    def listInterfaces(self):
        ...
        if ret is None:
            raise libvirtError('virConnectListInterfaces() failed', conn=self)
        return ret
    ...
    def listNWFilters(self):
        ...
        if ret is None:
            raise libvirtError('virConnectListNWFilters() failed', conn=self)
        return ret
    ...
    def listNetworks(self):
        ...
        if ret is None:
            raise libvirtError('virConnectListNetworks() failed', conn=self)
        return ret
    ...
    def listSecrets(self):
        ...
        if ret is None:
            raise libvirtError('virConnectListSecrets() failed', conn=self)
        return ret
    ...
    def listStoragePools(self):
        ...
        if ret is None:
            raise libvirtError('virConnectListStoragePools() failed', conn=self)
        return ret
    ...
    def lookupByID(self, id):
        ...
        if ret is None:
            raise libvirtError('virDomainLookupByID() failed', conn=self)
        __tmp = virDomain(self, _obj=ret)
        return __tmp
    ...
    def lookupByName(self, name):
        ...
        if ret is None:
            raise libvirtError('virDomainLookupByName() failed', conn=self)
        __tmp = virDomain(self, _obj=ret)
        return __tmp
    ...
    def lookupByUUID(self, uuid):
        ...
        if ret is None:
            raise libvirtError('virDomainLookupByUUID() failed', conn=self)
        __tmp = virDomain(self, _obj=ret)
        return __tmp
    ...
    def lookupByUUIDString(self, uuidstr):
        ...
        if ret is None:
            raise libvirtError('virDomainLookupByUUIDString() failed', conn=self)
        __tmp = virDomain(self, _obj=ret)
        return __tmp
    ...
    def networkCreateXML(self, xmlDesc):
        ...
        if ret is None:
            raise libvirtError('virNetworkCreateXML() failed', conn=self)
    ...
    def networkDefineXML(self, xml):
        ...
        if ret is None:
            raise libvirtError('virNetworkDefineXML() failed', conn=self)
        __tmp = virNetwork(self, _obj=ret)
        return __tmp
    ...
    def networkLookupByName(self, name):
        ...
        if ret is None:
            raise libvirtError('virNetworkLookupByName() failed', conn=self)
        __tmp = virNetwork(self, _obj=ret)
        return __tmp
    ...
    def networkLookupByUUID(self, uuid):
        ...
        if ret is None:
            raise libvirtError('virNetworkLookupByUUID() failed', conn=self)
        __tmp = virNetwork(self, _obj=ret)
        return __tmp
    ...
    def networkLookupByUUIDString(self, uuidstr):
        ...
        if ret is None:
            raise libvirtError('virNetworkLookupByUUIDString() failed', conn=self)
        __tmp = virNetwork(self, _obj=ret)
        return __tmp
    ...
    def newStream(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virStreamNew() failed', conn=self)
    ...
    def nodeDeviceCreateXML(self, xmlDesc, flags=0):
        ...
        if ret is None:
            raise libvirtError('virNodeDeviceCreateXML() failed', conn=self)
    ...
    def nodeDeviceLookupByName(self, name):
        ...
        if ret is None:
            raise libvirtError('virNodeDeviceLookupByName() failed', conn=self)
        __tmp = virNodeDevice(self, _obj=ret)
        return __tmp
    ...
    def nodeDeviceLookupSCSIHostByWWN(self, wwnn, wwpn, flags=0):
        ...
        if ret is None:
            raise libvirtError('virNodeDeviceLookupSCSIHostByWWN() failed', conn=self)
        __tmp = virNodeDevice(self, _obj=ret)
        return __tmp
    ...
    def numOfDefinedDomains(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectNumOfDefinedDomains() failed', conn=self)
        return ret
    ...
    def numOfDefinedInterfaces(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectNumOfDefinedInterfaces() failed', conn=self)
        return ret
    ...
    def numOfDefinedNetworks(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectNumOfDefinedNetworks() failed', conn=self)
        return ret
    ...
    def numOfDefinedStoragePools(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectNumOfDefinedStoragePools() failed', conn=self)
        return ret
    ...
    def numOfDevices(self, cap, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virNodeNumOfDevices() failed', conn=self)
        return ret
    ...
    def numOfDomains(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectNumOfDomains() failed', conn=self)
        return ret
    ...
    def numOfInterfaces(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectNumOfInterfaces() failed', conn=self)
        return ret
    ...
    def numOfNWFilters(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectNumOfNWFilters() failed', conn=self)
        return ret
    ...
    def numOfNetworks(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectNumOfNetworks() failed', conn=self)
        return ret
    ...
    def numOfSecrets(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectNumOfSecrets() failed', conn=self)
        return ret
    ...
    def numOfStoragePools(self):
        ...
        if ret == -1:
            raise libvirtError('virConnectNumOfStoragePools() failed', conn=self)
        return ret
    ...
    def nwfilterBindingCreateXML(self, xml, flags=0):
        ...
        if ret is None:
            raise libvirtError('virNWFilterBindingCreateXML() failed', conn=self)
    ...
    def nwfilterBindingLookupByPortDev(self, portdev):
        ...
        if ret is None:
            raise libvirtError('virNWFilterBindingLookupByPortDev() failed', conn=self)
        __tmp = virNWFilterBinding(self, _obj=ret)
        return __tmp
    ...
    def nwfilterDefineXML(self, xmlDesc):
        ...
        if ret is None:
            raise libvirtError('virNWFilterDefineXML() failed', conn=self)
    ...
    def nwfilterLookupByName(self, name):
        ...
        if ret is None:
            raise libvirtError('virNWFilterLookupByName() failed', conn=self)
        __tmp = virNWFilter(self, _obj=ret)
        return __tmp
    ...
    def nwfilterLookupByUUID(self, uuid):
        ...
        if ret is None:
            raise libvirtError('virNWFilterLookupByUUID() failed', conn=self)
        __tmp = virNWFilter(self, _obj=ret)
        return __tmp
    ...
    def nwfilterLookupByUUIDString(self, uuidstr):
        ...
        if ret is None:
            raise libvirtError('virNWFilterLookupByUUIDString() failed', conn=self)
        __tmp = virNWFilter(self, _obj=ret)
        return __tmp
    ...
    def restore(self, frm):
        ...
        if ret == -1:
            raise libvirtError('virDomainRestore() failed', conn=self)
        return ret
    ...
    def restoreFlags(self, frm, dxml=None, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainRestoreFlags() failed', conn=self)
        return ret
    ...
    def saveImageDefineXML(self, file, dxml, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virDomainSaveImageDefineXML() failed', conn=self)
        return ret
    ...
    def saveImageGetXMLDesc(self, file, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainSaveImageGetXMLDesc() failed', conn=self)
        return ret
    ...
    def secretDefineXML(self, xml, flags=0):
        ...
        if ret is None:
            raise libvirtError('virSecretDefineXML() failed', conn=self)
    ...
    def secretLookupByUUID(self, uuid):
        ...
        if ret is None:
            raise libvirtError('virSecretLookupByUUID() failed', conn=self)
        __tmp = virSecret(self, _obj=ret)
        return __tmp
    ...
    def secretLookupByUUIDString(self, uuidstr):
        ...
        if ret is None:
            raise libvirtError('virSecretLookupByUUIDString() failed', conn=self)
        __tmp = virSecret(self, _obj=ret)
        return __tmp
    ...
    def secretLookupByUsage(self, usageType, usageID):
        ...
        if ret is None:
            raise libvirtError('virSecretLookupByUsage() failed', conn=self)
        __tmp = virSecret(self, _obj=ret)
        return __tmp
    ...
    def setKeepAlive(self, interval, count):
        ...
        if ret == -1:
            raise libvirtError('virConnectSetKeepAlive() failed', conn=self)
        return ret
    ...
    def setMemoryParameters(self, params, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virNodeSetMemoryParameters() failed', conn=self)
        return ret
    ...
    def storagePoolCreateXML(self, xmlDesc, flags=0):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolCreateXML() failed', conn=self)
        __tmp = virStoragePool(self, _obj=ret)
        return __tmp
    ...
    def storagePoolDefineXML(self, xml, flags=0):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolDefineXML() failed', conn=self)
        __tmp = virStoragePool(self, _obj=ret)
        return __tmp
    ...
    def storagePoolLookupByName(self, name):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolLookupByName() failed', conn=self)
        __tmp = virStoragePool(self, _obj=ret)
        return __tmp
    ...
    def storagePoolLookupByTargetPath(self, path):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolLookupByTargetPath() failed', conn=self)
        __tmp = virStoragePool(self, _obj=ret)
        return __tmp
    ...
    def storagePoolLookupByUUID(self, uuid):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolLookupByUUID() failed', conn=self)
        __tmp = virStoragePool(self, _obj=ret)
        return __tmp
    ...
    def storagePoolLookupByUUIDString(self, uuidstr):
        ...
        if ret is None:
            raise libvirtError('virStoragePoolLookupByUUIDString() failed', conn=self)
        __tmp = virStoragePool(self, _obj=ret)
        return __tmp
    ...
    def storageVolLookupByKey(self, key):
        ...
        if ret is None:
            raise libvirtError('virStorageVolLookupByKey() failed', conn=self)
        __tmp = virStorageVol(self, _obj=ret)
        return __tmp
    ...
    def storageVolLookupByPath(self, path):
        ...
        if ret is None:
            raise libvirtError('virStorageVolLookupByPath() failed', conn=self)
        __tmp = virStorageVol(self, _obj=ret)
        return __tmp
    ...
    def suspendForDuration(self, target, duration, flags=0):
        ...
        if ret == -1:
            raise libvirtError('virNodeSuspendForDuration() failed', conn=self)
        return ret
    ...
    def _dispatchDomainEventIOErrorCallback(self, dom, srcPath, devAlias, action, cbData):
    ...
    def _dispatchDomainEventIOErrorReasonCallback(self, dom, srcPath, devAlias, action, reason, cbData):
        """Dispatches events to python user domain IO error event callbacks
        """
        cb = cbData['cb']
        opaque = cbData['opaque']
    ...
    def _dispatchDomainEventGraphicsCallback(self, dom, phase, localAddr, remoteAddr, authScheme, subject, cbData):
    ...
    def getAllDomainStats(self, stats=0, flags=0):
        ...
        for elem in ret:
            record = (
                virDomain(self, _obj=elem[0]), elem[1])
...
class virStream(object):
    ...
    def recvAll(self, handler, opaque):
        ...
        while True:
            got = self.recv(65536)
            if got == -2:
                raise libvirtError('cannot use recvAll with nonblocking stream')
            if len(got) == 0:
                break
            try:
    ...
    def sendAll(self, handler, opaque):
        ...
        while True:
            ...
            ret = self.send(got)
            if ret == -2:
                raise libvirtError('cannot use sendAll with nonblocking stream')
    ...
    def sparseRecvAll(self, handler, holeHandler, opaque):
        ...
        while True:
            ...
            if got == -2:
                raise libvirtError('cannot use sparseRecvAll with nonblocking stream')
            if got == -3:
    ...
    def sparseSendAll(self, handler, holeHandler, skipHandler, opaque):
        ...
        while True:
            ...
            if inData == False and sectionLen > 0:
                if self.sendHole(sectionLen) < 0 or skipHandler(self, sectionLen, opaque) < 0:
                    self.abort()
                continue
            want = 65536
            if want > sectionLen:
            ...
            ret = self.send(got)
            if ret == -2:
                raise libvirtError('cannot use sparseSendAll with nonblocking stream')
...
class virDomainSnapshot(object):
    ...
    def getParent(self, flags=0):
        ...
        if ret is None:
            raise libvirtError('virDomainSnapshotGetParent() failed', dom=self._dom)
        __tmp = virDomainSnapshot(self, _obj=ret)
        return __tmp
